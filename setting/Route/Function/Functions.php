...
class Functions
{
    ...
    public static function getServices(): array
    {
        ...
        return [
            ...
            4  => ['slug' => 'replacement', 'title' => 'Замена подошвы', 'price' => 18990, 'price_formatted' => '18 990', 'img' => 'services/Замена подошвы.png', 'bg' => '#1C1512', 'dark' => true, 'desc' => 'Полная замена подошвы с восстановлением оригинального вида и комфорта. ' . $brands, 'duration' => '3-7 дней'],
