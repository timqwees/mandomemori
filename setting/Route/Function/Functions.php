...
class Functions
{
    ...
    public static function getServices(): array
    {
        ...
        return [
            ...
            5  => ['slug' => 'restoration', 'title' => 'Реставрация', 'price' => 6490, 'price_formatted' => '6 490', 'img' => 'services/реставрация.png', 'bg' => '#1C1512', 'dark' => true, 'desc' => 'ХИТ! Реставрация обуви Loro Piana в Москве: царапины, потёртости, заломы, швы, молнии, фурнитура и цвет. ' . $brands, 'duration' => '3-7 дней', 'badge' => '🔥 ХИТ ПРОДАЖ', 'is_hit' => true, 'hit_order' => 4],
