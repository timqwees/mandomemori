...
class Functions
{
    ...
    public static function getServices(): array
    {
        ...
        return [
            ...
            3  => ['slug' => 'whitening', 'title' => 'Отбеливание подошвы', 'price' => 10990, 'price_formatted' => '10 990', 'img' => 'services/Отбеливание подошвы.png', 'bg' => '#1C1512', 'dark' => true, 'desc' => 'Профессиональное отбеливание подошвы с удалением желтизны и возвращением белоснежного вида. ' . $brands, 'duration' => '3-7 дней'],
            4  => ['slug' => 'sole-replacement', 'title' => 'Замена подошвы', 'price' => 18990, 'price_formatted' => '18 990', 'img' => 'services/Замена подошвы.png', 'bg' => '#1C1512', 'dark' => true, 'desc' => 'Полная замена подошвы с восстановлением оригинального вида и комфорта. ' . $brands, 'duration' => '3-7 дней'],
            ...
            8  => ['slug' => 'heel-taps-stiletto', 'title' => 'Набойки (шпильки)', 'price' => 1490, 'price_formatted' => '1 490', 'img' => 'services/Набойки (шпильки).png', 'bg' => '#1C1512', 'dark' => true, 'desc' => 'Установка набоек на женские туфли на шпильке. ' . $brands, 'duration' => '1 дней'],
            9  => ['slug' => 'heel-counters', 'title' => 'Задники', 'price' => 3490, 'price_formatted' => '3 490', 'img' => 'services/Набойки.png', 'bg' => '#1C1512', 'dark' => true, 'desc' => 'Замена твёрдых или мягких задников обуви. ' . $brands, 'duration' => '2-4 дней'],
            10 => ['slug' => 'bag-restoration', 'title' => 'Реставрация сумок', 'price' => 7990, 'price_formatted' => '7 990', 'img' => 'services/Реставрация сумок.png', 'bg' => '#1C1512', 'dark' => true, 'desc' => 'Восстановление сумок: царапины, потёртости, швы, молнии, фурнитура, цвет. ' . $brands, 'duration' => '3-10 дней'],
            11 => ['slug' => 'leather-painting', 'title' => 'Ручная роспись на коже', 'price' => 49900, 'price_formatted' => '49 900', 'img' => 'services/ручная роспись.png', 'bg' => '#1C1512', 'dark' => true, 'desc' => 'Уникальная ручная роспись на коже — дизайн выбираете вы, получаете единственную в мире вещь. ' . $brands, 'duration' => '5-14 дней'],
        ];
    }
