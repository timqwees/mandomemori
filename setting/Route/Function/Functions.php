...
class Functions
{
    ...
    {
        return [
            1  => ['slug' => 'sole-fresh', 'title' => 'Базовая химчистка', 'price' => 3490, 'price_formatted' => '3 490', 'img' => 'чистка.jpg', 'bg' => '#1C1512', 'dark' => true, 'desc' => 'Чистка повседневной обуви из гладкой кожи, замши, нубука и текстиля. С защитной пропиткой.', 'duration' => '1-6 дней'],
