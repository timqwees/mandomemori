...
<body>
  <div style="display:none" aria-hidden="true" itemscope itemtype="https://schema.org/LocalBusiness" itemid="https://mmclean.ru/#localbusiness">
    ...
    <span itemprop="priceRange">1490 RUB - 49900 RUB</span>
    <span itemprop="image">https://mmclean.ru/public/assets/images/favicon_full_black.svg</span>
    <span itemprop="address" itemscope itemtype="https://schema.org/PostalAddress"><span itemprop="streetAddress">Петровка 15/13 стр.5</span><span itemprop="addressLocality">Москва</span><span itemprop="addressRegion">Москва</span><span itemprop="postalCode">107031</span><span itemprop="addressCountry">RU</span></span>
    <span itemprop="geo" itemscope itemtype="https://schema.org/GeoCoordinates"><meta itemprop="latitude" content="55.765833"><meta itemprop="longitude" content="37.618889"></span>
  ...
  <header class="header" style="padding-block: 10px">
    <div class="container">
      <a href="/" class="logo">
        <img src="/public/assets/images/favicon_full_black.svg" alt="MANDO MEMORI — премиальная мастерская обуви Москва" class="logo-img" width="90" height="52">
      </a>
      <div class="header-right">
        <nav class="nav" id="main-nav">
          ...
          <a href="/order" class="nav-link" style="align-items: center;">
            ...
            <span>Передать обувь</span>
          </a>
          <a href="/blog" class="nav-link" style="align-items:center">
          ...
          <div class="flex items-center gap-3 hide-desktop">
            ...
            <a href="https://t.me/maksim1144?utm_source=site&utm_medium=telegram&utm_campaign=header_mobile" target="_blank" rel="noopener" class="menu_btn menu_btn--icon" aria-label="Telegram" data-tg="header_mobile">
          ...
          <div class="header-actions hide-mobile">
            <a href="tel:+79161829272" class="menu_btn">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07 19.5 19.5 0 01-6-6 19.79 19.79 0 01-3.07-8.67A2 2 0 014.11 2h3a2 2 0 012 1.72c.127.96.361 1.903.7 2.81a2 2 0 01-.45 2.11L8.09 9.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0122 16.92z"/></svg>
              +7 (916) 182-92-72
            </a>
            <a href="https://t.me/maksim1144?utm_source=site&utm_medium=telegram&utm_campaign=header_desktop" target="_blank" rel="noopener" class="menu_btn" data-tg="header_desktop">
              <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="22" y1="2" x2="11" y2="13"/><polygon points="22 2 15 22 11 13 2 9 22 2"/></svg>
              Telegram
            </a>
