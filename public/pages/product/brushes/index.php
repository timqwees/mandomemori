...
$siteINFO = ['canonical' => '/product/brushes', 'priority' => '0.7', 'changefreq' => 'weekly', 'index' => 'products'];

$pageTitle = 'MANDO MEMORI - Чистка спортивной обуви';
$pageDesc = 'Чистка спортивной обуви в Москве — химчистка кроссовок, кед и спортивной обуви от 2 990 ₽.';
$pageKeywords = 'Чистка спортивной обуви, MANDO MEMORI, химчистка обуви, чистка кроссовок Москва';
$currentSlug = 'brushes';
$canonical = $_SERVER['REQUEST_URI'] ?? '/product/brushes';
...
<main class="main svc-page">
  ...
  <nav class="breadcrumbs" aria-label="Breadcrumb">
    <ol itemscope itemtype="https://schema.org/BreadcrumbList">
      ...
      <li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
        <span itemprop="name">Чистка спортивной обуви</span>
  ...
  <script type="application/ld+json">
  {
    ...
    "image": "<?= \App\Services\Seo\SeoMeta::siteUrl() ?>/public/assets/images/mandomemori/чистка2.jpg",
  ...
  <section class="svc-hero">
    <div class="svc-hero-bg" style="background-image:url('/public/assets/images/mandomemori/чистка2.jpg')"></div>
    <div class="svc-hero-overlay"></div>
    <div class="container svc-hero-content">
      <div class="svc-hero-badge">Химчистка</div>
      <h1 class="svc-hero-title">Чистка спортивной обуви</h1>
      <p class="svc-hero-desc">Чистка спортивной обуви в Москве — химчистка кроссовок, кед и спортивной обуви от 2 990 ₽.</p>
      <div class="svc-hero-actions">
        <span class="svc-hero-price">2 990 ₽ <small>за пару</small></span>
    ...
    <div class="container">
      <div class="svc-order-card">
        <div class="svc-order-img">
          <img src="/public/assets/images/mandomemori/чистка2.jpg" alt="Чистка спортивной обуви | MANDO MEMORI" loading="lazy">
        </div>
        <div class="svc-order-body">
          <h2 class="svc-order-name">Чистка спортивной обуви</h2>
          <p class="svc-order-meta">Спортивная чистка · 1 пара</p>
          <div class="svc-order-price-row">
            <span class="svc-order-price">2 990 ₽</span>
            <span class="svc-order-unit">за пару</span>
          </div>
          <label class="svc-order-qty-label">Количество пар</label>
          <div class="svc-order-qty">
            <button type="button" class="product-qty-btn" data-id="7" data-action="dec">−</button>
            <input type="number" class="product-qty-input" id="qty-7" value="1" min="1" max="10">
            <button type="button" class="product-qty-btn" data-id="7" data-action="inc">+</button>
          </div>
          <button type="button" class="svc-order-cart-btn product-add-to-cart" data-id="7">Добавить в корзину</button>
    ...
    <div class="container">
      <div class="svc-about-grid">
        <div class="svc-about-text">
          ...
          <p>Спортивная обувь подвергается самым интенсивным нагрузкам. MANDO MEMORI предлагает профессиональную чистку кроссовок, кед и спортивной обуви с учётом особенностей материалов и конструкции каждого изделия.</p><p>Мы удаляем стойкие загрязнения, следы травы и масла. Особое внимание уделяем подошве и внутренней части. После чистки обувь обрабатывается дезодорирующим составом для свежести.</p>
          <div class="svc-tags"><span class="svc-tag">Кроссовки</span>
<span class="svc-tag">Кеды</span>
<span class="svc-tag">Текстиль</span>
<span class="svc-tag">Синтетика</span>
</div>
        </div>
    ...
    <div class="container">
      ...
      <div class="svc-faq-list">
            ...
            <button class="svc-faq-q" onclick="this.parentElement.classList.toggle('open')">
              <span>Какие виды спортивной обуви вы чистите?</span>
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="6 9 12 15 18 9"/></svg>
            </button>
            <div class="svc-faq-a"><p>Мы чистим кроссовки, кеды, беговые туфли, треккинговую обувь, шиповки и любую другую спортивную обувь.</p></div>
          </div>          <div class="svc-faq-item">
            <button class="svc-faq-q" onclick="this.parentElement.classList.toggle('open')">
              <span>Удаляете ли запах из спортивной обуви?</span>
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="6 9 12 15 18 9"/></svg>
            </button>
            <div class="svc-faq-a"><p>Да, после чистки мы обрабатываем обувь дезодорирующим составом, который устраняет неприятные запахи и освежает внутреннюю поверхность.</p></div>
          </div>
      </div>
    </div>
  </section>
  ...
  <section class="svc-related">
    <div class="container">
      ...
      <div class="svc-rel-grid">
            ...
            <div class="svc-rel-img">
              <img src="/public/assets/images/mandomemori/отбеливание.jpg" alt="Отбеливание подошвы" loading="lazy">
            </div>
            <div class="svc-rel-body">
