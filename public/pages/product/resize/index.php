...
<main class="main svc-page">
  ...
  <script type="application/ld+json">
  {
    ...
    "image": "<?= \App\Services\Seo\SeoMeta::siteUrl() ?>/public/assets/images/solefresh/1771327434678-8059.jpg",
  ...
  <section class="svc-hero">
    <div class="svc-hero-bg" style="background-image:url('/public/assets/images/solefresh/1771327434678-8059.jpg')"></div>
    ...
    <div class="container">
      <div class="svc-order-card">
        <div class="svc-order-img">
          <img src="/public/assets/images/solefresh/1771327434678-8059.jpg" alt="Растяжка обуви | MANDO MEMORI" loading="lazy">
        </div>
    ...
    <div class="container">
      ...
      <div class="svc-rel-grid">
            ...
            <div class="svc-rel-img">
              <img src="/public/assets/images/solefresh/1771329486969-2642.jpg" alt="Восстановление формы обуви" loading="lazy">
            </div>
