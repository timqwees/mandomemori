...
$siteINFO = ['canonical' => '/product/towel', 'priority' => '0.7', 'changefreq' => 'weekly', 'index' => 'products'];

$pageTitle = 'MANDO MEMORI - Глубокая чистка микрофиброй';
$pageDesc = 'Глубокая чистка обуви микрофиброй в Москве — деликатная очистка без повреждения материала от 2 490 ₽.';
$pageKeywords = 'Глубокая чистка микрофиброй, MANDO MEMORI, химчистка обуви, чистка микрофиброй Москва';
$currentSlug = 'towel';
$canonical = $_SERVER['REQUEST_URI'] ?? '/product/towel';
...
<main class="main svc-page">
  ...
  <nav class="breadcrumbs" aria-label="Breadcrumb">
    <ol itemscope itemtype="https://schema.org/BreadcrumbList">
      ...
      <li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
        <span itemprop="name">Глубокая чистка микрофиброй</span>
  ...
  <script type="application/ld+json">
  {
    ...
    "@type": "Product",
    "name": "Глубокая чистка микрофиброй",
    "description": "Глубокая чистка обуви микрофиброй в Москве — деликатная очистка без повреждения материала от 2 490 ₽.",
    "image": "<?= \App\Services\Seo\SeoMeta::siteUrl() ?>/public/assets/images/solefresh/1771329961198-4780.jpg",
    "category": "Ручная чистка",
    "offers": {
      "@type": "Offer",
      "price": "2490",
      "priceCurrency": "RUB",
  ...
  <section class="svc-hero">
    <div class="svc-hero-bg" style="background-image:url('/public/assets/images/solefresh/1771329961198-4780.jpg')"></div>
    <div class="svc-hero-overlay"></div>
    <div class="container svc-hero-content">
      <div class="svc-hero-badge">Ручная чистка</div>
      <h1 class="svc-hero-title">Глубокая чистка микрофиброй</h1>
      <p class="svc-hero-desc">Глубокая чистка обуви микрофиброй в Москве — деликатная очистка без повреждения материала от 2 490 ₽.</p>
      <div class="svc-hero-actions">
        <span class="svc-hero-price">2 490 ₽ <small>за пару</small></span>
    ...
    <div class="container">
      <div class="svc-order-card">
        <div class="svc-order-img">
          <img src="/public/assets/images/solefresh/1771329961198-4780.jpg" alt="Глубокая чистка микрофиброй | MANDO MEMORI" loading="lazy">
        </div>
        <div class="svc-order-body">
          <h2 class="svc-order-name">Глубокая чистка микрофиброй</h2>
          <p class="svc-order-meta">Ручная чистка · 1 пара</p>
          <div class="svc-order-price-row">
            <span class="svc-order-price">2 490 ₽</span>
            <span class="svc-order-unit">за пару</span>
          </div>
          <label class="svc-order-qty-label">Количество пар</label>
          <div class="svc-order-qty">
            <button type="button" class="product-qty-btn" data-id="9" data-action="dec">−</button>
            <input type="number" class="product-qty-input" id="qty-9" value="1" min="1" max="10">
            <button type="button" class="product-qty-btn" data-id="9" data-action="inc">+</button>
          </div>
          <button type="button" class="svc-order-cart-btn product-add-to-cart" data-id="9">Добавить в корзину</button>
    ...
    <div class="container">
      <div class="svc-about-grid">
        <div class="svc-about-text">
          ...
          <p>Глубокая ручная чистка микрофиброй от MANDO MEMORI — это бережный уход за обувью из деликатных материалов. Мы используем профессиональные салфетки из микрофибры, которые эффективно удаляют загрязнения, не царапая поверхность.</p><p>Процедура включает многоэтапную очистку, полировку и финишную обработку. Идеально для обуви из чувствительных материалов, требующих особого подхода.</p>
    ...
    <div class="container">
      ...
      <div class="svc-faq-list">
            ...
            <button class="svc-faq-q" onclick="this.parentElement.classList.toggle('open')">
              <span>Чем отличается от обычной химчистки?</span>
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="6 9 12 15 18 9"/></svg>
            </button>
            <div class="svc-faq-a"><p>Чистка микрофиброй — это полностью ручная процедура без использования машин. Она более деликатная и подходит для чувствительных материалов.</p></div>
          </div>          <div class="svc-faq-item">
            <button class="svc-faq-q" onclick="this.parentElement.classList.toggle('open')">
              <span>Для каких материалов подходит?</span>
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="6 9 12 15 18 9"/></svg>
            </button>
            <div class="svc-faq-a"><p>Метод подходит для кожи, замши, нубука, текстиля и синтетики. Особенно рекомендуется для обуви с деликатными декоративными элементами.</p></div>
          </div>
      </div>
    </div>
  </section>
  ...
  <section class="svc-related">
    <div class="container">
      ...
      <div class="svc-rel-grid">
            ...
            <div class="svc-rel-img">
              <img src="/public/assets/images/solefresh/1771326480456-1968.jpg" alt="Питание и кондиционирование кожи" loading="lazy">
            </div>
            <div class="svc-rel-body">
