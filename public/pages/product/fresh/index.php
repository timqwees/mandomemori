...
$siteINFO = ['canonical' => '/product/fresh', 'priority' => '0.7', 'changefreq' => 'weekly', 'index' => 'products'];

$pageTitle = 'MANDO MEMORI - Дезодорация обуви';
$pageDesc = 'Дезодорация обуви в Москве — удаление неприятных запахов и освежение от 990 ₽.';
$pageKeywords = 'Дезодорация обуви, MANDO MEMORI, химчистка обуви, удаление запаха Москва';
$currentSlug = 'fresh';
$canonical = $_SERVER['REQUEST_URI'] ?? '/product/fresh';
...
<main class="main svc-page">
  ...
  <nav class="breadcrumbs" aria-label="Breadcrumb">
    <ol itemscope itemtype="https://schema.org/BreadcrumbList">
      ...
      <li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
        <span itemprop="name">Дезодорация обуви</span>
  ...
  <script type="application/ld+json">
  {
    ...
    "@type": "Product",
    "name": "Дезодорация обуви",
    "description": "Дезодорация обуви в Москве — удаление неприятных запахов и освежение от 990 ₽.",
    "image": "<?= \App\Services\Seo\SeoMeta::siteUrl() ?>/public/assets/images/mandomemori/1771334546823-1997.jpg",
    "category": "Устранение запаха",
    "offers": {
      "@type": "Offer",
      "price": "990",
      "priceCurrency": "RUB",
  ...
  <section class="svc-hero">
    <div class="svc-hero-bg" style="background-image:url('/public/assets/images/mandomemori/1771334546823-1997.jpg')"></div>
    <div class="svc-hero-overlay"></div>
    <div class="container svc-hero-content">
      <div class="svc-hero-badge">Устранение запаха</div>
      <h1 class="svc-hero-title">Дезодорация и свежесть</h1>
      <p class="svc-hero-desc">Дезодорация обуви в Москве — удаление неприятных запахов и освежение от 990 ₽.</p>
      <div class="svc-hero-actions">
        <span class="svc-hero-price">990 ₽ <small>за пару</small></span>
    ...
    <div class="container">
      <div class="svc-order-card">
        <div class="svc-order-img">
          <img src="/public/assets/images/mandomemori/1771334546823-1997.jpg" alt="Дезодорация и свежесть | MANDO MEMORI" loading="lazy">
        </div>
        <div class="svc-order-body">
          <h2 class="svc-order-name">Дезодорация и свежесть</h2>
          <p class="svc-order-meta">Устранение запаха · 1 пара</p>
          <div class="svc-order-price-row">
            <span class="svc-order-price">990 ₽</span>
            <span class="svc-order-unit">за пару</span>
          </div>
          <label class="svc-order-qty-label">Количество пар</label>
          <div class="svc-order-qty">
            <button type="button" class="product-qty-btn" data-id="11" data-action="dec">−</button>
            <input type="number" class="product-qty-input" id="qty-11" value="1" min="1" max="10">
            <button type="button" class="product-qty-btn" data-id="11" data-action="inc">+</button>
          </div>
          <button type="button" class="svc-order-cart-btn product-add-to-cart" data-id="11">Добавить в корзину</button>
    ...
    <div class="container">
      <div class="svc-about-grid">
        <div class="svc-about-text">
          ...
          <p>Со временем в обуви появляется неприятный запах, который не устраняется обычной чисткой. MANDO MEMORI предлагает профессиональную дезодорацию с использованием антибактериальных средств, которые уничтожают бактерии — источник запаха.</p><p>Обработка проводится внутри и снаружи обуви. Результат — свежесть и комфорт при каждой носке. Рекомендуется для спортивной и ежедневной обуви.</p>
          <div class="svc-tags"><span class="svc-tag">Все типы обуви</span>
</div>
        </div>
    ...
    <div class="container">
      ...
      <div class="svc-faq-list">
            ...
            <button class="svc-faq-q" onclick="this.parentElement.classList.toggle('open')">
              <span>Как надолго устраняется запах?</span>
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="6 9 12 15 18 9"/></svg>
            </button>
            <div class="svc-faq-a"><p>Эффект сохраняется от 2 до 4 недель в зависимости от интенсивности носки. Рекомендуем повторять процедуру раз в месяц.</p></div>
          </div>          <div class="svc-faq-item">
            <button class="svc-faq-q" onclick="this.parentElement.classList.toggle('open')">
              <span>Безопасна ли обработка для обуви?</span>
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="6 9 12 15 18 9"/></svg>
            </button>
            <div class="svc-faq-a"><p>Да, мы используем антибактериальные средства, безопасные для всех материалов. Они не повреждают цвет и структуру обуви.</p></div>
          </div>
      </div>
    </div>
  </section>
  ...
  <section class="svc-related">
    <div class="container">
      ...
      <div class="svc-rel-grid">
            ...
            <div class="svc-rel-img">
              <img src="/public/assets/images/mandomemori/1771329597854-9744.jpg" alt="Чистка спортивной обуви" loading="lazy">
            </div>
            <div class="svc-rel-body">
            ...
            <div class="svc-rel-img">
              <img src="/public/assets/images/mandomemori/1771329961198-4780.jpg" alt="Глубокая чистка микрофиброй" loading="lazy">
            </div>
            <div class="svc-rel-body">
