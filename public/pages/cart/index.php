    ...
    <div class="container">
      ...
      <div class="cart-flow-grid">
        ...
        <div class="cart-flow-step">
          ...
          <p class="cart-flow-step-desc">Вызываете курьера или приходите в пункт — называете номер чека или показываете его на телефоне. Сотрудник находит заказ и забирает обувь сразу</p>
        </div>
        ...
        <div class="cart-flow-step">
          ...
          <p class="cart-flow-step-desc">По вашему чеку выставляется счёт, и мастер приступает к чистке — без лишних объяснений и разговоров, всё уже в чеке</p>
        </div>
