  ...
  <section class="services-grid" id="services">
    ...
    <div class="cards-slider" id="cards-slider">
      <div class="cards">
        <?php
        $services = [
          ['slug' => 'sole-fresh', 'img' => '1771658911567-5599.jpg', 'title' => 'Базовый уход', 'desc' => 'Чистка, пропитка, питание и кондиционирование — всё для ежедневного ухода за обувью из кожи, замши и текстиля.', 'price' => 'от 1 990', 'duration' => '1-6 дней'],
          ['slug' => 'premium', 'img' => '1771602419874-9009.jpg', 'title' => 'Премиум-уход', 'desc' => 'Глубокая чистка люксовых брендов, покраска, реставрация цвета и полный комплекс для безупречного вида.', 'price' => 'от 3 990', 'duration' => '1-6 дней'],
          ['slug' => 'wipes', 'img' => '1771658902373-8032.jpg', 'title' => 'Специальная обработка', 'desc' => 'Отбеливание подошвы, растяжка, восстановление формы, глубокая чистка микрофиброй и защитное вощение.', 'price' => 'от 990', 'duration' => '1-3 дней'],
          ['slug' => 'soft', 'img' => '1771658750798-5571.jpg', 'title' => 'Уход за материалами', 'desc' => 'Деликатная чистка замши и нубука, восстановление ворса, чистка спортивной обуви и экипировки.', 'price' => 'от 2 990', 'duration' => '1-6 дней'],
        ];
