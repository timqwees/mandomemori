...
<main class="vacancies-page">
  ...
  <section class="vacancies-hero" style="background-color: #f5f5f7; color: #ffffff; min-height: 70vh">
      <div class="vacancies-hero-bg has-mobile" style="background-image: url('/public/assets/images/mandomemori/фон2.jpg')" data-mobile-bg="/public/assets/images/mandomemori/фон2.jpg"></div>
