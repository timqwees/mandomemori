  ...
  <main class="main-content  mt-0">
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            ...
            <p class="text-lead text-white">Зарегестрируйся на форуме, чтобы использовать все дополнительные возможности и бонусы</p>
          </div>
        </div>
      </div>
    </div>
    <div class="container">
      <div class="row mt-lg-n10 mt-md-n11 mt-n10 justify-content-center">
        <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
          <div class="card z-index-0">
            ...
            <div class="card-body">
              ...
              <form role="form" action="src/actions/register.php" method="post" enctype="multipart/form-data">
                <div class="mb-3">
                  <input type="text" class="form-control" aria-label="Name" id="fistname" name="firstname" placeholder="Имя" value="<?php echo old('firstname') ?>"
            <?php echo validationErrorAttr('firstname'); ?>
        >
        <?php if(hasValidationError('firstname')): ?>
            <small><?php echo validationErrorMessage('firstname'); ?></small>
        <?php endif; ?>
                </div>
                
      
                <div class="mb-3">
                  <input type="text" class="form-control" aria-label="Name" id="lastname" name="lastname" placeholder="Фамилия" value="<?php echo old('lastname') ?>"
            <?php echo validationErrorAttr('lastname'); ?>
        >
        <?php if(hasValidationError('lastname')): ?>
            <small><?php echo validationErrorMessage('lastname'); ?></small>
        <?php endif; ?>
                </div>
                
                
                <div class="mb-3">
                  <input class="form-control" placeholder="Email" aria-label="Email" type="text" id="email" name="email" value="<?php echo old('email') ?>"
        ...
        <?php endif; ?>
                ...
                <div class="mb-3">
                  <input class="form-control" placeholder="Avatar" type="file" id="avatar" name="avatar"
        ...
        <?php endif; ?>
            ...
            <?php endif; ?>
                ...
                <div class="mb-3">
                  <input class="form-control" type="password" id="password_confirmation" name="password_confirmation" placeholder="Verify Password"></div>
    ...
    <fieldset>
                  ...
                  <label class="form-check-label" for="terms">
                    Я принимаю все условия <a class="text-dark font-weight-bolder"> пользовательского соглашения</a>
                </label>
            </fieldset>
         </div>
                ...
                <div class="text-center">
                  <button class="btn bg-gradient-dark w-100 my-4 mb-2" type="submit" id="submit" disabled>Sign up</button>
                </div>
                
                
                <p class="text-sm mt-3 mb-0">Уже есть аккаунт ? <a href="/login.php" class="text-dark font-weight-bolder">Войти</a></p>
              </form>
            </div>
          </div>
        </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8 mb-4 mx-auto text-center">
          <a href="https://vk.com/mandomemori" target="_blank" class="text-secondary me-xl-5 me-3 mb-sm-0 mb-2">
            VK
          </a>
          <a href="https://t.me/mandomemori" target="_blank" class="text-secondary me-xl-5 me-3 mb-sm-0 mb-2">
            Telegram
          </a>
      ...
      <div class="row">
        <div class="col-8 mx-auto text-center mt-1">
          <p style="font-size: 13px" class="mb-0 text-secondary">
            ...
            </script> Надёжная команда по ухода за вашими вещами
          </p>
        </div>
      </div>
    </div>
